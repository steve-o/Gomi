...
/* column number definitions for table gomiOutageMeasurementTable */
       ...
       #define COLUMN_GOMIOUTAGEMEASUREMENTPLUGINUNIQUEINSTANCE		2
       #define COLUMN_GOMIOUTAGEMEASUREMENTLOGINNAME		3
       #define COLUMN_GOMIACCUMULATEDOUTAGETIME		4
       #define COLUMN_GOMACCUMULATEDFAILURES		5
       #define COLUMN_GOMIRECORDINGSTARTTIME		6

/* column number definitions for table gomiOutageEventTable */
       #define COLUMN_GOMIOUTAGEEVENTPLUGINID		1
       #define COLUMN_GOMIOUTAGEEVENTPLUGINUNIQUEINSTANCE		2
       #define COLUMN_GOMIOUTAGEEVENTLOGINNAME		3
