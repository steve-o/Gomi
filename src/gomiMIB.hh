...
/* column number definitions for table gomiPluginTable */
       ...
       #define COLUMN_GOMIPLUGINSYMBOLMAP		12
       #define COLUMN_GOMIPLUGINDEFAULTTIMEZONE		13
       #define COLUMN_GOMIPLUGINTIMEZONEDATABASE		14
       #define COLUMN_GOMIPLUGINDEFAULTDAYCOUNT		15
...
/* column number definitions for table gomiClientTable */
       ...
       #define COLUMN_GOMICLIENTHOSTNAME		4
       #define COLUMN_GOMICLIENTIPADDRESS		5
       #define COLUMN_GOMICLIENTRSSLPORT		6
       #define COLUMN_GOMICLIENTSESSIONNAME		7
       #define COLUMN_GOMICLIENTCONNECTIONNAME		8
       #define COLUMN_GOMICLIENTPUBLISHERNAME		9
...
/* column number definitions for table gomiClientPerformanceTable */
       ...
       #define COLUMN_GOMIITEMREQUESTREJECTED		34
       #define COLUMN_GOMIITEMVALIDATED		35
       #define COLUMN_GOMIITEMMALFORMED		36
       #define COLUMN_GOMIITEMNOTFOUND		37
       #define COLUMN_GOMIITEMSENT		38
       #define COLUMN_GOMIITEMCLOSED		39
       #define COLUMN_GOMIITEMEXCEPTION		40
       #define COLUMN_GOMIOMMINACTIVECLIENTSESSIONRECEIVED		41
       #define COLUMN_GOMIOMMINACTIVECLIENTSESSIONEXCEPTION		42
